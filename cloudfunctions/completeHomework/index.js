...
exports.main = async (event, context) => {
  ...
  const { homeworkId, proofImage, comment, rating, ratingPercent, checkinDate, childId, account } = event;
  ...
  if (!canPerform(currentMember, 'checkin')) {
    return {
      success: false,
      errMsg: getPermissionError(currentMember, 'checkin', '您只有只读权限，无法打卡')
    };
  }
